...
class Example(object):
    def __init__(self, name=None, explanation=None, candidate=None, denotation=None, semantics=None):
        self.name = name
...
cdr_examples = [
    ...
    Example(
        ...
        explanation="""Label false if any word before the disease starts with 
            'improv'""",
